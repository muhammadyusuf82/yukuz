        ...
        <div className="bg-white rounded-4xl shadow-sm p-6 sm:p-8 border border-slate-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    {/* From Region */}
                    <div className="space-y-1.5">
                        <label className="text-sm font-semibold text-slate-700 ml-1">Qayerdan (viloyat) *</label>
                        <input
                            name="route_starts_where_region"
                            value={formData.route_starts_where_region}
                            onChange={handleChange}
                    ...
                    {/* From City */}
                    <div className="space-y-1.5">
                        <label className="text-sm font-semibold text-slate-700 ml-1">Qayerdan (shahar) *</label>
                        <input
                            name="route_starts_where_city"
                            value={formData.route_starts_where_city}
                            onChange={handleChange}
                    ...
                    {/* To Region */}
                    <div className="space-y-1.5">
                        <label className="text-sm font-semibold text-slate-700 ml-1">Qayerga (viloyat) *</label>
                        <input
                            name="route_ends_where_region"
                            value={formData.route_ends_where_region}
                            onChange={handleChange}
                    ...
                    {/* To City */}
                    <div className="space-y-1.5">
                        <label className="text-sm font-semibold text-slate-700 ml-1">Qayerga (shahar) *</label>
                        <input
                            name="route_ends_where_city"
                            value={formData.route_ends_where_city}
                            onChange={handleChange}
                        ...
                        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-lg">
                            ...
                            <div className="p-4 border-t border-slate-200 bg-blue-50/50">
                                <h4 className="text-lg font-semibold text-blue-800 mb-3 flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-blue-600"></div>
                                    Yuklash manzili (boshlanish)
                                </h4>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label className="text-sm font-semibold text-slate-600 mb-1 block">Viloyat *</label>
                                        <input
                                            type="text"
                                            name="route_starts_where_region"
                                            value={formData.route_starts_where_region}
                                            ...
                                            className="w-full bg-white border border-slate-200 rounded-xl p-3 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                                            placeholder="Viloyatni kiriting"
                                        />
                                    </div>
                                    <div>
                                        <label className="text-sm font-semibold text-slate-600 mb-1 block">Shahar *</label>
                                        <input
                                            type="text"
                                            name="route_starts_where_city"
                                            value={formData.route_starts_where_city}
                                    ...
                                    <div>
                                        <label className="text-sm font-semibold text-slate-600 mb-1 block">Koordinatalar (max 9 raqam)</label>
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="relative">
                                                <input
                                                    type="text"
                                                    name="route_starts_where_lat"
                                                    value={formData.route_starts_where_lat}
                                                    onChange={handleChange}
                                                    className="w-full bg-white border border-slate-200 rounded-xl p-3 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none pr-10"
                                                    placeholder="Kenglik"
                                                    maxLength={9}
                                                />
                                                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-slate-400">
                                                    {formData.route_starts_where_lat.length}/9
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <input
                                                    type="text"
                                                    name="route_starts_where_lon"
                                                    value={formData.route_starts_where_lon}
                                                    onChange={handleChange}
                                                    className="w-full bg-white border border-slate-200 rounded-xl p-3 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none pr-10"
                                                    placeholder="Uzunlik"
                                                    maxLength={9}
                                                />
                                                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-slate-400">
                                                    {formData.route_starts_where_lon.length}/9
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <button
                                        type="button"
                                        onClick={() => handleClearLocation('start')}
                                        disabled={!formData.route_starts_where_lat}
                                        className="flex items-center gap-2 bg-red-100 hover:bg-red-200 text-red-600 px-4 py-2 rounded-lg transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <FaSyncAlt />
                                        Boshlanish manzilini tozalash
                                    </button>
                                </div>
                            </div>
                            
                            {/* End Location Form */}
                            <div className="p-4 border-t border-slate-200 bg-red-50/50">
                                <h4 className="text-lg font-semibold text-red-800 mb-3 flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-red-600"></div>
                                    Yetkazib berish manzili (tugash)
                                </h4>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label className="text-sm font-semibold text-slate-600 mb-1 block">Viloyat *</label>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="relative">
                                                <input
                                                    type="text"
                                                    name="route_ends_where_lat"
                                                    value={formData.route_ends_where_lat}
                                                    onChange={handleChange}
                                                    className="w-full bg-white border border-slate-200 rounded-xl p-3 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none pr-10"
                                                    placeholder="Kenglik"
                                                    maxLength={9}
                                                />
                                                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-slate-400">
                                                    {formData.route_ends_where_lat.length}/9
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <input
                                                    type="text"
                                                    name="route_ends_where_lon"
                                                    value={formData.route_ends_where_lon}
                                                    onChange={handleChange}
                                                    className="w-full bg-white border border-slate-200 rounded-xl p-3 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none pr-10"
                                                    placeholder="Uzunlik"
                                                    maxLength={9}
                                                />
                                                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-slate-400">
                                                    {formData.route_ends_where_lon.length}/9
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <button
                                        type="button"
                                        onClick={() => handleClearLocation('end')}
                                        disabled={!formData.route_ends_where_lat}
                                        className="flex items-center gap-2 bg-red-100 hover:bg-red-200 text-red-600 px-4 py-2 rounded-lg transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <FaSyncAlt />
                                        Tugash manzilini tozalash
                                    </button>
                                </div>
                            </div>
